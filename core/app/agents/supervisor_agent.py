...
from core.database.models import Job # Asumiendo que esta tabla existe y está relacionada
from core.database.models import AgentRun
from core.db.session import SessionLocal # Asumiendo que esta es la forma de obtener una sesión
...
from core.app.agents.data_design_agent import DataDesignAgent
...
from core.app.agents.agent_base import AgentBase # Asumiendo una clase base

# --- NUEVOS AGENTES IMPORTADOS ---
from core.app.agents.mockup_agent import MockupAgent
from core.app.agents.security_agent import SecurityAgent
# ---------------------------------
