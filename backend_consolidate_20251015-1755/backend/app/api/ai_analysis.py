...
try:
    from backend.app.config.ai_config import ai_config
except ModuleNotFoundError:
    # Fallback a settings como ai_config
    from backend.app.config.settings import settings as ai_config
...
from backend.app.agents.supervisor_simple import SupervisorSimple 

router = APIRouter(tags=["AI Analysis"])
deepseek_client = DeepSeekClient() 
intake_agent = IntakeAgent() # Instanciación para /analyze-requirements
supervisor = SupervisorSimple() # Instanciación del supervisor para la orquestación
