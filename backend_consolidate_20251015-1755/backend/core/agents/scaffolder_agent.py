...
class ScaffolderAgent(AgentBase):
    """Agent responsible for project scaffolding"""
    
    def __init__(self):
        super().__init__("ScaffolderAgent")
    
    def generate_model_code(self, model_spec: Dict[str, Any]) -> str:
...
'''
    ...
    def generate_crud_router(self, model_spec: Dict[str, Any]) -> str:
...
'''
    ...
    def run(self, project_id: str, specification: Dict[str, Any], generated_path: str) -> dict:
...
# Backward compatibility - keep the standalone run function
def run(project_id: str, specification: Dict[str, Any], generated_path: str) -> dict:
    ...
    return agent.run(project_id, specification, generated_path)
