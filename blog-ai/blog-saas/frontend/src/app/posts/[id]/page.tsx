  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" }}>
      ...
      <a href={`https://twitter.com/intent/tweet?text=${text}&url=${encoded}`} target="_blank" rel="noopener"
        style={{ display: "flex", alignItems: "center", gap: "0.4rem", fontSize: "0.75rem", color: "#aaa", textDecoration: "none", padding: "0.4rem 0.8rem", border: "1px solid #333", fontFamily: "monospace", letterSpacing: "0.05em" }}>
      ...
      <button onClick={copyLink}
        style={{ display: "flex", alignItems: "center", gap: "0.4rem", fontSize: "0.75rem", color: copied ? "#4a9a4a" : "#aaa", background: "none", padding: "0.4rem 0.8rem", border: `1px solid ${copied ? "#2a4a2a" : "#333"}`, fontFamily: "monospace", letterSpacing: "0.05em", cursor: "pointer" }}>
