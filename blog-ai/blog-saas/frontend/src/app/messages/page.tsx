      ...
      <div style={{ display: "flex", flex: 1, maxWidth: "900px", width: "100%", margin: "0 auto", height: "calc(100vh - 60px)" }}>
        <div style={{ width: "280px", borderRight: "1px solid #0f0f0f", display: "flex", flexDirection: "column", flexShrink: 0 }}>
          <div style={{ padding: "1rem", borderBottom: "1px solid #0f0f0f", position: "relative" }}>
            <input value={search} onChange={e => searchUsers(e.target.value)} placeholder="Find user..."
          ...
          <div style={{ flex: 1, overflowY: "auto" }}>
            {loading ? (
              ...
              <div key={c.id} onClick={() => openConv(c)} style={{ padding: "0.875rem 1rem", cursor: "pointer", borderBottom: "1px solid #0f0f0f", background: activeConv?.id === c.id ? "#111" : "transparent" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                  {c.other_user?.avatar_url
                    ? <img src={c.other_user.avatar_url} style={{ width: 36, height: 36, borderRadius: "50%", objectFit: "cover", flexShrink: 0 }} />
                    : <div style={{ width: 36, height: 36, borderRadius: "50%", background: "#1a2a1a", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.8rem", color: "#4a9a4a", fontFamily: "monospace", flexShrink: 0 }}>{(c.other_user?.display_name || "?")[0].toUpperCase()}</div>
                  }
            ...
            <>
              <div style={{ padding: "1rem 1.5rem", borderBottom: "1px solid #0f0f0f", display: "flex", alignItems: "center", gap: "0.75rem" }}>
                {activeConv.other_user?.avatar_url
                  ...
                  : <div style={{ width: 32, height: 32, borderRadius: "50%", background: "#1a2a1a", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.75rem", color: "#4a9a4a", fontFamily: "monospace" }}>{(activeConv.other_user?.display_name || "?")[0].toUpperCase()}</div>
                }
