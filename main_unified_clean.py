"""
SISTEMA PRINCIPAL UNIFICADO - VERSIÓN LIMPIA
Sistema de generación de proyectos reales con IA
"""
import asyncio
import uvicorn
...
# Agregar el path actual para imports relativos
...
async def create_simple_project(request: ProjectRequest):
    ...
    try:
        ...
        # Crear proyecto usando RealProjectBuilder
...
if __name__ == "__main__":
    print("🚀 INICIANDO SISTEMA CONSOLIDADO AI v2.0 (CLEAN)")
