# 🍎 DietAI - Sistema Inteligente de Gestión de Dietas

Una aplicación completa para gestión de dietas personalizadas con análisis de imágenes mediante IA.

## 🚀 Características

- ✅ **Registro y autenticación** de usuarios
- ✅ **Generación de dietas** personalizadas basadas en:
  - Edad, género, altura, peso
  - Nivel de actividad
  - Objetivos (pérdida de peso, ganancia muscular, mantenimiento)
  - Restricciones dietéticas y alergias
- ✅ **Análisis de imágenes de comida** mediante IA
- ✅ **Gestión de inventario** de alimentos
- ✅ **Reconocimiento de despensa** por imagen
...
# create_final_version.sh

echo "🎯 Creando versión final funcional de DietAI..."

cd /workspaces/Scouta/diet_ai

# 1. Detener todos los contenedores
docker-compose -f diet_ai_complete/docker-compose.yml down 2>/dev/null || true
docker-compose -f simple_app/docker-compose.yml down 2>/dev/null || true
docker ps -aq | xargs docker stop 2>/dev/null || true
docker ps -aq | xargs docker rm 2>/dev/null || true

# 2. Crear directorio final
rm -rf diet_ai_final
mkdir -p diet_ai_final
cd diet_ai_final

# 3. Crear estructura simple pero organizada
